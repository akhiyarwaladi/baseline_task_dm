...
model_path = os.path.join(parent_dir, 'models', '02_model_sms_spam.pkl')
...
print(f"   - KNN (K=5, cosine): Accuracy {results['test_accuracy']:.4f}")
print(f"   - Vectorizer: max_features=500, ngram_range=(1,2)")
